...
public class ItemDumper {
	...
	public ItemDumper(String dumpRoot, String metaFile) throws IOException
	{
	...
	protected void saveImage(byte[] imageByte, String imageName) throws IOException
	{
		...
		IOUtils.copyBytes(new ByteArrayInputStream(imageByte), ofs, 10240);
		ofs.close();
	}
	public static void main(String[] args)
	{
		...
		try {
			ItemDumper dumper = new ItemDumper(dumpRoot, metaFile);
			dumper.dump();
		} catch (IOException e) {
